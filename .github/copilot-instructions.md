...
1. Read `documentation/INSTRUCTIONS.md` and `documentation/FLUTTER_APP_INSTRUCTIONS.md` before making code changes.
2. Produce a 3–6 line plan before any non-trivial change: requirement summary, files to change, and verification steps.
3. Prefer linking to existing documentation instead of copying it. Use markdown links to the files in `documentation/`.
...
6. For architectural changes: add an ADR under `documentation/00-governance/adr/` and reference it in the PR description.
