...
Detail: [`guardian-docs/01-product-discovery/STAKEHOLDERS.md`](01-product-discovery/STAKEHOLDERS.md)
...
This charter is implemented through the tiers described in [`guardian-docs/00-governance/DOCUMENT_HIERARCHY.md`](00-governance/DOCUMENT_HIERARCHY.md).
