...
5. **A new module requires** a row in this table, a package, an entry in [`FEATURE_INVENTORY.md`](FEATURE_INVENTORY.md), and its own tables documented in [`guardian-docs/03-database/tables/`](../03-database/tables/).
