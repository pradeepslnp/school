...
### Tier 0 — Governance (repository root and `guardian-docs/00-governance/`)
...
### Tier 1 — Product Discovery (`guardian-docs/01-product-discovery/`)
...
### Tier 2 — System Design (`guardian-docs/02-system-design/`)
...
### Tier 3 — Database (`guardian-docs/03-database/`)
...
### Tier 4 — API (`guardian-docs/04-api/`)
...
### Tier 6 — Development (`guardian-docs/06-development/`)
...
### Tier 7 — Testing (`guardian-docs/07-testing/`)
...
### Tier 8 — Deployment (`guardian-docs/08-deployment/`)
