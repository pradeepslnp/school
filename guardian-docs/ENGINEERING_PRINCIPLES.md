...
**Enforcement:** an ArchUnit test suite in `guardian-common` fails the build on violations. See [`guardian-docs/06-development/ARCHITECTURE_ENFORCEMENT.md`](06-development/ARCHITECTURE_ENFORCEMENT.md).
...
See [`guardian-docs/02-system-design/MULTI_TENANCY.md`](02-system-design/MULTI_TENANCY.md).
...
- One global exception handler maps domain failures to the standard error envelope in [`guardian-docs/04-api/ERROR_CATALOG.md`](04-api/ERROR_CATALOG.md).
