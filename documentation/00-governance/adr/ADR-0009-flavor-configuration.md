...
The repository contains multiple Flutter applications (`flutter/driver_attender_app`, `flutter/parent_app`, `admin`). Developers need a consistent way to run development and production-like builds locally and in CI.
