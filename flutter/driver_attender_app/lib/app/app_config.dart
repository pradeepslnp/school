...
///
/// See `.vscode/launch.json`. The "simulate offline" configuration points at an
/// unreachable host so ADR-0008's local queue and deferred sync can be exercised without
/// disabling the device's network.
class AppConfig {
