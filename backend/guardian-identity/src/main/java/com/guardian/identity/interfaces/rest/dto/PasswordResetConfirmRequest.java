 ...
 * password's strength are decided server-side ({@code ResetPasswordUseCase}, {@code
 * PasswordPolicy}), never trusted from here. The email + code pair identifies the account — the
 * code alone is not unique — mirroring how phone sign-in verifies a code against a resolved phone.
 */
